...
public class PrintfFormat {
  ...
  public PrintfFormat(String fmtArg)
    ...
    this(DEFAULT_GROUPING_SEPARATOR, DEFAULT_DECIMAL_SEPARATOR,fmtArg);
  }
  /**
   * Constructs an array of control specifications
   * possibly preceded, separated, or followed by
   ...
   * malformed.
   */
  public PrintfFormat(char groupingSeparator, char decimalSeparator,String fmtArg)
      throws IllegalArgumentException {
  ...
  private class ConversionSpecification {
    ...
    */
    ...
    private String printDFormat(short x) {
      return printDFormat(new Short(x).toString());
    }
    /**
